...
/******************************************************************************************************/
/*
*Description: Initialize your timer with your given structure configuration  
* Input     : Configuration structure 
* Output    : Error Checking
*___________________________________________________________________________________________________________*/
extern u8 Timer_Init(Timer_Configuration_S_H* Confg_S);
/*
*Description: Start the Timer Function
*Input :Timer channel(1,2,3), Required Time 
*Output :Error Check 
*______________________________________________________________________________*/
extern u8 Timer_Start(u8 Timer_Channel,double Required_Time);
/*
*Description : Cut of the timer Counter 
*Input : Timer channel 
*Output :Error check 
*______________________________________________________________*/
extern u8 Timer_Stop(u8 Timer_Channel);
/*
*Description : Reset the timer to the Initial value 
*Input : Timer channel 
*Output : Error chack
